...
<html>
    ...
    <div class="x-body layui-anim layui-anim-up">
        <blockquote class="layui-elem-quote">欢迎@if(session('adminName.status'))超级@endif管理员：
            <span class="x-red">{{session('adminName.name')}}</span>！当前时间:{{date('Y-m-d H:i:s',time())}}</blockquote>
